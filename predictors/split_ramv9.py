...
def gen_submission():
    ...
    outfile_name = str(sys.argv[0][a0len-5])+str(sys.argv[0][a0len-4])+"_"+str(sys.argv[1])+"_"+str(sys.argv[2])+"_"+str(sys.argv[3])+"_sequence_"+str(sequence[0])+str(sequence[1])+str(sequence[2])+str(sequence[3])+str(sequence[4])+str(sequence[5])+str(sequence[6])+str(sequence[7])+str(sequence[8])+"-51-.csv"
