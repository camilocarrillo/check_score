#!/bin/bash
export file='/afs/cern.ch/user/c/carrillo/EXP/software_versions/split_ramv10.py'
#3
...
free
python run_book_dayci_month_split_ramv10.py 1 batch True 1 2 13 3 4 5 6 7 8
free
