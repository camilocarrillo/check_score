...
def prepare_arrays_match():
    ...
    while 1:
        ...
        if 3 in sequence:
            if is_booking:
                fillme((srch_destination_id,hotel_country,hotel_market,is_package,user_id,posa_continent,hotel_continent,srch_destination_type_id),array_31,hotel_cluster,append_1,True)
                fillme((srch_destination_id,hotel_country,hotel_market,is_package,user_id),array_32,hotel_cluster,append_1,True)
                fillme((srch_destination_id,hotel_country,hotel_market,is_package),array_33,hotel_cluster,append_1,True)

        #4
        if 4 in sequence:
            fillme((srch_destination_id,hotel_country,hotel_market,is_package,user_id,posa_continent,hotel_continent,srch_destination_type_id),array_41,hotel_cluster,append_1,True)
            fillme((srch_destination_id,hotel_country,hotel_market,is_package,user_id,posa_continent),array_42,hotel_cluster,append_1,True)
            fillme((srch_destination_id,hotel_country,hotel_market,is_package,user_id),array_43,hotel_cluster,append_1,True)

        #5
        if 5 in sequence:
            fillme((srch_destination_id,hotel_country,hotel_market,is_package,user_id,posa_continent),array_51,hotel_cluster,append_1,True)
            fillme((srch_destination_id,hotel_country,hotel_market,is_package,user_id,),array_52,hotel_cluster,append_1,True)
            fillme((srch_destination_id,hotel_country,hotel_market,is_package),array_53,hotel_cluster,append_1,True)
...
def gen_submission():
    ...
    outfile_name = str(sys.argv[0][a0len-5])+str(sys.argv[0][a0len-4])+"_"+str(sys.argv[1])+"_"+str(sys.argv[2])+"_"+str(sys.argv[3])+"_sequence_"+str(sequence[0])+str(sequence[1])+str(sequence[2])+str(sequence[3])+str(sequence[4])+str(sequence[5])+str(sequence[6])+str(sequence[7])+str(sequence[8])+".csv"
    ...
    while 1:
        ...
        for round in range(0,10):
            ...
            #3
            if sequence[round]==3:
                count[3][1] += algos((srch_destination_id,hotel_country,hotel_market,is_package,user_id,posa_continent,hotel_continent,srch_destination_type_id),array_31,filled,maxs[3][1],history,sequence[round])
                count[3][2] += algos((srch_destination_id,hotel_country,hotel_market,is_package,user_id),array_32,filled,maxs[3][2],history,sequence[round])
                count[3][3] += algos((srch_destination_id,hotel_country,hotel_market,is_package),array_33,filled,maxs[3][3],history,sequence[round])

            #4
            if sequence[round]==4:
                count[4][1] += algos((srch_destination_id,hotel_country,hotel_market,is_package,user_id,posa_continent,hotel_continent,srch_destination_type_id),array_41,filled,maxs[4][1],history,sequence[round])
                count[4][2] += algos((srch_destination_id,hotel_country,hotel_market,is_package,user_id,posa_continent),array_42,filled,maxs[4][2],history,sequence[round])
                count[4][3] += algos((srch_destination_id,hotel_country,hotel_market,is_package,user_id),array_43,filled,maxs[4][3],history,sequence[round])

            #5
            if sequence[round]==5:
                count[5][1] += algos((srch_destination_id,hotel_country,hotel_market,is_package,user_id,posa_continent),array_51,filled,maxs[5][1],history,sequence[round])
                count[5][2] += algos((srch_destination_id,hotel_country,hotel_market,is_package,user_id),array_52,filled,maxs[5][2],history,sequence[round])
                count[5][3] += algos((srch_destination_id,hotel_country,hotel_market,is_package),array_53,filled,maxs[5][3],history,sequence[round])
