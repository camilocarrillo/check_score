...
#3
export v31='srch_destination_id,hotel_country,hotel_market,is_package,user_id,ci_year,book_year'
export v32='srch_destination_id,hotel_country,hotel_market,is_package,user_id,ci_year'
export v33='srch_destination_id,hotel_country,hotel_market,is_package,user_id'
#4
export v41='srch_destination_id,hotel_country,hotel_market,is_package,user_id,posa_continent,hotel_continent,hotel_country'
export v42='srch_destination_id,hotel_country,hotel_market,is_package,user_id,posa_continent,hotel_continent'
export v43='srch_destination_id,hotel_country,hotel_market,is_package,user_id,posa_continent'
#5
...
free
python run_split_ramv9.py 1 pcwits True 1 2 13 4 3 5 6 7 8  
free