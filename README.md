...
1. The second 1.5M lines are meant to measure the score of your algorithm.  
  ...
  * A file called mytest.csv, with the same format of test.csv was generated from the second half. ~150M. wget http://test-carrillo.web.cern.ch/test-carrillo/kag/exp/mytest.csv
